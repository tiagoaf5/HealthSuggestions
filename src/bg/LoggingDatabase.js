var logDB = (function () {
    ...
    tDB.open = function(callback) {
        ...
        // Handle datastore upgrades. (create and change version)
                ...
                switch (logTable) {
                    ...
                    case TABLE_SEARCH_PAGE:
                        ...
                        if (toSave) {
                            ...
                            result['Search']['SearchPages'].push({
                                SERPOrder: SERPOrder,
                    ...
                    case TABLE_EVENT:
                        ...
                        switch (data.EventType) {
                            case 'copy':
                                result['Events'].push(
                                    buildObject({
                                        EventType: 'copy', EventTimestamp: timestamp, copyText: data.copyText,
                                        url: global.page_url
                                    }));
                                break;
                            case 'find':
                            ...
                            case 'SwitchSE':
                                result['Events'].push(buildObject({
                                    EventType: 'SwitchSE', EventTimestamp: timestamp,
                            ...
                            case 'ClickUrl':
                                result['Events'].push(buildObject({
                                    EventType: data.EventType, EventTimestamp: timestamp,
